...
async def confirm_order(order_id: str, body: OrderConfirmRequest, request: Request):
    result = await request.app.state.commerce_service.confirm_order(
        _owner(request),
        order_id,
...
async def get_entitlement(request: Request):
    return success(request.app.state.commerce_service.get_entitlement(_owner(request)))


@router.get("/orders")
async def list_orders(request: Request):
    return success(request.app.state.commerce_service.list_orders(_owner(request)))
